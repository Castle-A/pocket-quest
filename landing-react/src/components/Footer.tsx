  ...
  return (
    <footer className="bg-[#F9FAFB] border-t border-black/[0.06]">
      <div className="max-w-[1200px] mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 reveal">
        ...
        <div className="pt-8 border-t border-black/[0.04] flex flex-col md:flex-row items-center justify-between gap-4 reveal stagger-2">
